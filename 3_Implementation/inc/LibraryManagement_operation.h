/**
 * @file _LibraryManagement .h
 * @author Vanaja Sri
 * @brief Header file for LibraryManagement  application with Arithmetic operations
 *
 */

#ifndef __LibraryManagement_OPERATIONS_H__
#define __LibraryManagement_OPERATIONS_H__
#include"inc.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
